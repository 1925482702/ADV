...
使用方法:
    python train_adv.py --data ./LLVIP_RGB.yaml --epochs 100 --epsilon_max 0.05
"""
...
class AdversarialDetectionTrainer(DetectionTrainer):
    """
    带对抗训练的检测训练器
    ...
    def _do_train(self, world_size=1):
        ...
        LOGGER.info(f'🔥 对抗训练开始，共 {self.epochs} epochs...')
...
def parse_args():
    parser = argparse.ArgumentParser(description='Adversarial Training for YOLOv8')
    parser.add_argument('--model', type=str, default='./ultralytics/cfg/models/v8/yolov8m.yaml',
                        help='Model config file')
    parser.add_argument('--data', type=str, default='./LLVIP_RGB.yaml',
    ...
    parser.add_argument('--project', type=str, default='./runs/adv_train',
                        help='Project name')
    parser.add_argument('--name', type=str, default='adv',
...
def main():
    ...
    try:
        trainer = AdversarialDetectionTrainer(overrides=train_args)
        trainer.train()
