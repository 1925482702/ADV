...
# Teacher -> student mappings for model_yaml/yolov8m_shift_Fusion.yaml.
...
class FrozenShiftTrainer(DetectionTrainer):
    """Detection trainer for Shift models with frozen dual-branch backbones."""
    ...
    def _setup_train(self, world_size):
        """Run standard setup, then rebuild optimizer/scheduler for trainable params only."""
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        """Create the ShiftDetectionModel and load the frozen teacher backbones."""
...
def parse_args():
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="./model_yaml/yolov8m_shift_Fusion.yaml",
        help="模型配置文件",
    )
...
def main():
    ...
    LOGGER.info("=" * 60)
    LOGGER.info("Frozen Backbone Shift Training")
    LOGGER.info("=" * 60)
