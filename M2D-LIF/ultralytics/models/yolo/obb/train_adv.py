"""
ADV 对抗蒸馏训练器 (OBB版本) —— 作为 ultralytics 的插件

核心思路：
  - self.model = 标准 OBBModel（和 baseline 完全相同架构）
...
class ADVOBBTrainer(OBBTrainer):
    """
    对抗蒸馏训练器 (OBB版本)，继承标准 OBBTrainer。
